...
if ( ! function_exists( 'kaiso_setup' ) ) :
	...
	function kaiso_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'kaiso' ),
		) );
...
function kaiso_scripts() {
	...
	wp_enqueue_script( 'kaiso-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'kaiso-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
